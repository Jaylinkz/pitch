                            ...
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    <div>
                                        ...
                                        <h5 class="card-subtitle">all recent reports made</h5>
                                    </div>
                                    <div class="ms-auto">
                                    </div>
                                </div>
                                    ...
                                    <table class="table mb-0 table-hover align-middle text-nowrap">
                                        ...
                                        <tr>
                                           ...
                                           <td>{{$report->email}}</td>
                                                ...
                                                <td>
                                                    <a href="{{ route('details', $report->id) }}" title="View product"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
